...
bookRouter.route('/searchBookByYear').post((req, res) => new book_controller_1.BookController().searchBookByYear(req, res));
bookRouter.route('/searchBookByPublisher').get((req, res) => new book_controller_1.BookController().searchBookByPublisher(req, res));
bookRouter.route('/searchBookByStyle').get((req, res) => new book_controller_1.BookController().searchBookByStyle(req, res));
